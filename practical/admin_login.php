...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $mysql = "SELECT * FROM admin WHERE Username = '$usrname' and Password = '$psswrd'";
...
<body style="background-color: lightblue;">
    <form action = "" method = "POST">
        ...
        <div class= buttons>
            <div class = login>
            <a href='user_view.php'><button class="login" type="submit">Login</button></a>
            </div>
            <div class = register>
            <a href='register_user.php'><button class="register" type="button">Register</button></a>
            </div>
        </div>
